...
1. **수원 주차 출처 조사** — 수원시 일반 주차장 설치 조례가 법제처 ordin DB에 없음(보훈시설 조례만). 주차 기준이 건축 조례·시행규칙 등 다른 조례에 있는지 조사 후 등재(현재 유일한 보류 카드).
2. **조례 지자체 추가 확장** — 성남·청주·전주·천안 등 대도시. 특례시처럼 "도 시" 지자체기관명 형식 주의.
